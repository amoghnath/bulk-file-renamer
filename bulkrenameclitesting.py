...
print(colors.OKGREEN+'[/]'+colors.ENDC+' 1.Number-Text-Oldname '+colors.YELLOW+'(e.g. 1.file.txt, 2.file.txt ...)'+colors.ENDC) 
print(colors.OKGREEN+'[/]'+colors.ENDC+' 2.Number-Only '+colors.YELLOW+'(e.g. 1., 2. ...)'+colors.ENDC)
print(colors.OKGREEN+'[/]'+colors.ENDC+' 3.Date '+colors.YELLOW+'(e.g. 2020-12-24, 2012-17-21 ...)'+colors.ENDC)
print(colors.OKGREEN+'[/]'+colors.ENDC+' 4.UPPERCASE '+colors.YELLOW+'(e.g. ROCKYOU.TXT, HELLO.JPG ...)'+colors.ENDC)
print(colors.OKGREEN+'[/]'+colors.ENDC+' 5.lowercase '+colors.YELLOW+'(e.g. rockyou.txt, hello.jpg ...)\n'+colors.ENDC)
